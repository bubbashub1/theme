...
function bubba_hub_theme_setup() {
 ...
 add_theme_support('responsive-embeds'); register_nav_menus(array('primary'=>__('Primary Menu','bubba-hub')));
}
...
function bubba_hub_body_classes($classes){$classes[]='bubba-hub-theme';return $classes;}
